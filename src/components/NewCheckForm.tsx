...
export function NewCheckForm({ onNavigate }: NewCheckFormProps) {
  ...
  }, [selectedCheckbook, autoCheckNumber, checkbooks]);
                        ...
                        <div className="flex gap-4">
                          ...
                          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                            <Button
                              ...
                              className={`rounded-2xl h-14 px-8 whitespace-nowrap font-bold text-lg transition-all duration-300 ${
                                autoCheckNumber 
                                  ? `${bankStyle.primary} text-white shadow-lg hover:shadow-xl transform hover:scale-105` 
                                  : 'border-3 border-gray-300 hover:border-gray-400 bg-white text-gray-700'
                              }`}
                              size="default"
                            >
                              {autoCheckNumber ? (
